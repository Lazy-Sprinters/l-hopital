...
export class CentreCards extends React.Component {
  ...
  show(centreList){          /* tochange */
    ...
    let value2=centreList[i+2];
      ...
      <CardComponent1 Tags={value.tags} img={value.cen.FrontImage} Name={value.cen.Name} Address={value.cen.Address} Cost={value.costing} Distance={value.dis} OpeningTime={value.cen.OpeningTime} ClosingTime={value.cen.ClosingTime}/>
      <CardComponent1 Tags={value.tags} img={value1.cen.FrontImage} Name={value1.cen.Name} Address={value1.cen.Address} Cost={value1.costing} Distance={value1.dis} OpeningTime={value1.cen.OpeningTime} ClosingTime={value1.cen.ClosingTime}  />
      <CardComponent1 Tags={value.tags} img={value2.cen.FrontImage} Name={value2.cen.Name} Address={value2.cen.Address} Cost={value2.costing} Distance={value2.dis} OpeningTime={value2.cen.OpeningTime} ClosingTime={value2.cen.ClosingTime}  />
      </div>);
    }
    let value=centreList[len-(3*(len/3))];
    let value1=centreList[len-(3*(len/3))+1];
    {/*let value2=centreList[len-(3*(len/3))+2];*/}
    if((len%3)==1){
      code.push(<div className="home__hero-row">
      <CardComponent1 Tags={value.tags} img={value.cen.FrontImage} Name={value.cen.Name} Address={value.cen.Address} Cost={value.costing} Distance={value.dis} OpeningTime={value.cen.OpeningTime} ClosingTime={value.cen.ClosingTime}/>
      </div>)
